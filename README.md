# 情绪像素 · MoodTracker 2.1.5

一个温柔、私密、无需注册的心情空间。保留 Expo / React Native 原生项目，支持 iOS、Android 和响应式网页。

**2.1.5（9）发布进度（2026-09-08）**：产品更名「情绪像素」，采用已确认的彩色像素图标，并修复启动页的底色方块与加载衔接。220 项测试、独立原生编译、正式构建及 IPA 验签均通过；正在完成上传身份验证，尚未核实新版本 TestFlight 可用。以下发布记录对应此前的安装包。
